...
def test_health_check():
    ...
    with patch("app.services.redis_service.check_redis_connection") as mock_redis, \
         patch("app.celery_app.celery_app.control.inspect") as mock_inspect:
        
        mock_redis.return_value = True
        mock_stats = MagicMock()
        mock_stats.stats.return_value = {"worker1": {}}
        mock_inspect.return_value = mock_stats
